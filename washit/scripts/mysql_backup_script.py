...
DB_NAME = 'anyclean'
BACKUP_PATH = '/home/ubuntu/project/anyclean/washit/dbbackup'


# Getting current datetime to create seprate backup folder like "12/01/2015".
...
if multi:
   ...
   while p <= flength:
       ...
       dumpcmd = "mysqldump -u " + DB_USER + " -p" + DB_USER_PASSWORD + " " + db + " > " + BACKUP_PATH + "/" + db + DATETIME + ".sql"
       os.system(dumpcmd)
       p = p + 1
   dbfile.close()
else:
